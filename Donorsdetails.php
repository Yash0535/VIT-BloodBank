	...
	<div class="left" style="width:561px;border:1px solid #D7D7D7;border-top:0px;border-bottom:0px;">
		<div class="left" style="width:561px;">
			<div style="background: url(div-spheadbg-crv.gif) no-repeat; width:561px; height:50px;"><p style="padding-top:10px;padding-left:15px;"><font class="headtxt"> Donors' Details
					...
					<div align = "left" class="left" style="padding:10px;"><div><font class="headtxt">Filter The Record :</font></div><br>
					<form name="sfrm"  method="post" style="margin:0px;" action="filter.php" onsubmit="return iFormCheck();">
						<ul style="padding-top:10px;padding-left:30px;">
							<li style="padding-bottom:10px;"><input type="checkbox" name="Filter[]" value="NoDisease" tabindex="27" style="vertical-align:middle;" >&nbsp;Don't Have Any Disease </li>
							<li style="padding-bottom:10px;"><input type="checkbox" name="Filter[]" value="DonationYes" tabindex="28" style="vertical-align:middle;" >&nbsp;Last Donation Date Is Before 3 Months</li>
						</ul>
						<input type="image" src="filter.png" width="55" height="21" border="0" alt=""  ></div><br>
					</form>
			...
			<div class="left" style="width:541px;">
				<div class="left" style="width:535px;">	
					<div style="padding:20px;">
						<p>	
						 ...
						 <?php
							...
							$sql="SELECT Donor_ID,Donor_name,Gender,Date_of_Birth,city,area,Date_of_Donation,Donor_mobile,Residence,Office,blood_group,Any_disease,Weight,DonorEmail,verified FROM $tbl_name" ;
                    ...
                    <ul class='list left'>
                      ...
                      <li>".$row['Date_of_Donation'];
                      ?>
                  </li>
                      <li><a href="viewcertificate.php?donor_id=<?php echo $row['Donor_ID']?>" >
						View Certificate</a> 
                       </li>
                       
                      <li>
                      <?php echo $row['DonorEmail']."</li>
                    ...
                    <ul class='list left'>
                      ...
                      if($row['verified'] == 'Yes'){
                      	...
                      	echo "<input type='checkbox' name='verify' value='Verify' tabindex='27' style='vertical-align:middle;' >";
                      }
                    ...
                    ?>
                    <button><a href="verify.php?donor_id=<?php echo $row['Donor_ID']?>">Apply</a></button>
                    <?php
                    echo "***********************************************************************************************************
