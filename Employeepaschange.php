...
<div class="left" style="width:563px;">
	...
	<div class="left" style="width:561px;border:1px solid #D7D7D7;border-top:0px;border-bottom:0px;">
		<div class="left" style="width:561px;">
			<div style="background: url(images/div-spheadbg-crv.gif) no-repeat; width:561px; height:50px;"><p style="padding-top:10px;padding-left:15px;"><font class="headtxt">  Change Your Password
			...
			<div class="left" style="width:541px;">
				<div class="left" style="width:535px;">	
					<div style="padding:20px;">
						...
						<form action="rpasschange.php" id="EmploymentApplication100" method="post" onsubmit="return ValidateForm(this);">

<table border="0" cellpadding="3" cellspacing="0">
<tr> <td>
<label for="EmpID">Employee ID :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="ID" type="text" maxlength="50" style="width: 260px" /> </td>
 <td>
<label for="EmpID">Old Password</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="old" type="Password" maxlength="50" style="width: 260px" /> </td> <td>
<tr> <td>
<label for="Phone">New Password</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="new" type="Password" maxlength="50" style="width: 260px" /> </td> <td>
<tr><td>
<label for="Salary">Retype New Password</label>&nbsp;&nbsp;&nbsp; <input name="rnew" type="Password" maxlength="50" style="width: 260px" /> </td> <td>
 <tr> <td>
