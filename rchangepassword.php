			...
			<div class="left" style="width:541px;">
				<div class="left" style="width:535px;">	
					<div style="padding:20px;">
						...
						<form action="rpaschange.php" id="EmploymentApplication100" method="post" onsubmit="return ValidateForm(this);">

<table border="0" cellpadding="3" cellspacing="0">
<tr> <td>
<label for="EmpID">Recipient ID :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="ID" type="text" maxlength="50" style="width: 260px" /> </td>
 <td>
