...
<div class="left" style="width:563px;">
	...
	<div class="left" style="width:561px;border:1px solid #D7D7D7;border-top:0px;border-bottom:0px;">
		<div class="left" style="width:561px;">
			<div style="background: url(images/div-spheadbg-crv.gif) no-repeat; width:561px; height:50px;"><p style="padding-top:10px;padding-left:15px;"><font class="headtxt">Blood Inventory</font></p></div>
	 ...
	 <div style="background: url(right-panel-bg-top.jpg) no-repeat top right; width:200px;">
		<div style="background: url(right-panel-bg-bottom.gif) no-repeat bottom right; width:200px;">
			<div align = "left" style="padding: 10px 13px 0px 13px">	
				<div  style="padding: 10px 3px;border-bottom: 1px solid #fff;"><a href="Wholechart.php" class="headtxt1">Whole Chart</a></div>

				<div  style="padding: 10px 3px;border-top: 1px solid #D2D2D2;border-bottom: 1px solid #fff;"><a href="wholetable.php" class="headtxt1">Whole Table</a></div>

				

				<div  style="padding: 10px 3px;border-bottom: 1px solid #D2D2D2;"><a href="sendrequest.php" class="headtxt1">Send Request To Donor</a></div>
