	 ...
	 <div style="background: url(right-panel-bg-top.jpg) no-repeat top right; width:200px;">
		<div style="background: url(right-panel-bg-bottom.gif) no-repeat bottom right; width:200px;">
			<div align = "left" style="padding: 10px 13px 0px 13px">	
				<div  style="padding: 10px 3px;border-bottom: 1px solid #fff;"><a href="Donorsdetails.php" class="headtxt1">Profile Picture</a></div>

				<div  style="padding: 10px 3px;border-bottom: 1px solid #fff;"><a href="Donorsdetails.php" class="headtxt1">Profile</a></div>

				<div  style="padding: 10px 3px;border-top: 1px solid #D2D2D2;border-bottom: 1px solid #fff;"><a href="rchangepassword.php" class="headtxt1">Reset Password</a></div>
